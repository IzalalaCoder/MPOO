...
public class Tamagotchi {
    ...
    public Tamagotchi(int lifeTime, int min, int max) {
        ...
        this.minEnergy = min;
        this.maxEnergy = max;
        this.energy = this.alea(min, ((min + max) / 2));
        this.energyDebt = 0;
    }
    ...
    public void eat(int mealNb) {
        ...
        int n = this.energy;
        int add = this.alea(1, ENERGY_GAIN);
        while (add != 0) {
            this.energy += n + mealNb;
            add -= 1;
        }
    }
    ...
    public void evolve() {
        ...
        if (this.energy == 0) {
            ...
            int mini = this.min(this.energyDebt, this.energy - 1);
            this.energyDebt = this.energyDebt - mini;
            this.energy =  (this.energy - 1) - mini; 
        }
    }
